...
namespace RPSGenerator.Objects
{
  public class RPSClassTest
  {
    ...
    public void GameResult_PaperVsPaper_true()
    {
      ...
      Assert.Equal("Tie Game - Click to Play Again", newRPSClass.GameResult());
    }
    ...
    public void GameResult_PaperVsRock_true()
    {
      ...
      Assert.Equal("Player 1 Wins - Click to Play Again", newRPSClass.GameResult());
    }
    ...
    public void GameResult_PaperVsScissors_true()
    {
      ...
      Assert.Equal("Player 2 Wins - Click to Play Again", newRPSClass.GameResult());
    }
